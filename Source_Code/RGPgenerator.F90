...
PROGRAM RGP
      ...
      character :: hrf*3, herr*255, lfluid*30, loutfile*30, name_of_file*12, name_of_fluid*8
      ...
      WRITE(*,*)
      WRITE(*,*) 'Enter - NIST fluid file (i.e. R1233ZD.fld)'
	  READ(*,*) name_of_file
	  WRITE(*,*)
      WRITE(*,*) 'Enter - NIST fluid name (i.e. R1233ZD)'
	  READ(*,*) name_of_fluid
	  WRITE(*,*)
      WRITE(*,*) 'Output Data File Name (i.e. filename.rgp):'
      READ (*,*) lOutfile
      OPEN(UNIT=10,FILE=lOutFile,STATUS='NEW')
      lfluid= name_of_fluid
      hf(1) =  name_of_file
      hfmix='hmx.bnc'
      hrf='DEF'
...
!     WRITE(*,*) 'Dipole Moment [debye]: ',dip
      ...
      WRITE(*,*)'Max Density:                      ',Dmax*wm,'kg/m^3'
      ...
      ! SETUP OUTPUT FILE 
      WRITE(10,901)' $$$$HEADER'
      WRITE(10,902)' $$$',lfluid !character*8 !(key into the RGP file see NOTE 3)  if this program is used with a fluid other than CO2, this line will need to be changed, along with the corresponding line in the $$$DATA header
      ...
      WRITE(10,903)'Fluid ',lfluid,' from NIST'!character*50(description of the material)
      WRITE(10,901)'NAME'
      WRITE(10,901) lfluid !character*8 !(material name, same as $$$<component>)
      WRITE(10,901)'INDEX'
      WRITE(10,901) lfluid !character*50 !(index into clients RGDB program)
      ...
      WRITE(10,900)TminSat!real (K)
      WRITE(10,901)'TMAX_SATURATION'
      WRITE(10,900)TmaxSat!real (K)
      ...
      WRITE(10,901) '$$$$DATA'
      WRITE(10,902) '$$$',lfluid !character*8 (key into the RGP file see NOTE 3)
      WRITE(10,*) 1!enter an integer (this line is ignored in ANSYS CFX)
      WRITE(10,901)'$$PARAM'! See NOTE 4
      WRITE(10,*) 26!enter an integer(number of parameters)
      WRITE(10,901)'DESCRIPTION'
